...
import hps.mentee.MenteeRequestError;
...
private final String REQUEST_SUCCESS = "mentee_homepage.jsp";
private final String REQUEST_ERROR = "mentee_request.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        MenteeRequestError errors = new MenteeRequestError();
        ...
        try{
            ...
            String skillsID = dao.getSkillsID(skills);
            String requestID = dao.generateRequestID(skills);
            ...
            if(isError){
                ...
                boolean result = dao.menteeCreateRequest(requestID , menteeID, 
